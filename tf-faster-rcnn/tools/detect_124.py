...
#                      'pulled pork', 'hamburger', 'cavity') #change
...
# OUTPUT_DIR = '../output_bbox_tiny_car'
OUTPUT_DIR = '../output_bbox_horizontal_car'
...
if __name__ == '__main__':
    ...
    demonet = 'res101'
    # dataset = 'car_track1'
    # dataset = 'tiny_car_track1'
    dataset = 'horizontal_car_track1'
