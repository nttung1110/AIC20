...
from iou_tracker.util import iou, load_mot
from iou_tracker.vis_tracker import VisTracker
PATH_SVID = "./Center_net/new_iou_tracker_visualized"

def track_viou_edited(video_path, detections, sigma_l, sigma_h, sigma_iou, t_min, ttl, tracker_type, keep_upper_height_ratio):
    """ V-IOU Tracker.
    ...
    output = cv2.VideoWriter(PATH_SVID + '/' + video_name, cv2.VideoWriter_fourcc('M','J','P','G'), 5.0, (width, height))
    print(video_path)
